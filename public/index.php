<?php
	...
	// page basic settings
	$page_title 		= "Image Folder Resizer";
	$page_description 	= "Batch resize and reformat images within a hierarchy of folders.";
	$page_author		= "Morgan";
	$page_keywords		= "Heledron, Hadron, Cymaera, Image, File, Converter, Resizer, Bulk, Batch, Mass, PNG, JPEG, WebP";
